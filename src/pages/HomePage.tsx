    ...
    <div className="flex flex-col bg-white text-gray-900 font-sans overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-20 pt-32 sm:pt-36 lg:pt-40 pb-16 sm:pb-24 lg:pb-32 grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div>
            <h1 className="text-3xl sm:text-4xl lg:text-6xl font-extrabold leading-tight mb-6 sm:mb-8">
              ...
              <span className="text-[#005d28]">Future</span>
            </h1>
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-6 sm:mb-10 max-w-md sm:max-w-xl">
            ...
            <a
              href="#contact"
              className="px-6 sm:px-8 py-3 sm:py-4 text-white font-semibold rounded-lg shadow transition block text-center sm:inline-block"
      ...
      <section className="bg-gray-50 py-16 sm:py-20 lg:py-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          ...
          >
            Key <span className="text-[#005d28]">Features</span> of Our Doors
          </motion.h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {[
              ...
              <motion.div
                ...
                className="group bg-white p-6 sm:p-8 rounded-lg shadow-sm hover:shadow-lg border border-gray-200 transition-all duration-500 cursor-pointer relative overflow-hidden"
              >
                <div
                  className="w-12 h-12 sm:w-14 sm:h-14 rounded-lg flex items-center justify-center group-hover:scale-105 transition-all duration-300 mb-4 sm:mb-6"
                  style={{ backgroundColor: "#005d28" }}
                >
                  <CheckCircle className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
                </div>
                <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-2 sm:mb-4 leading-tight">
                  {feature.title}
                </h3>
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 items-center">
            ...
            >
              {[
                { title: "Top Layer", desc: "Thousand-ton press finish", delay: 0.2 },
                { title: "Surface Layer", desc: "Melamine-urea-formaldehyde decorative film", delay: 0.4 },
                { title: "Core Layer", desc: "FRP/Carbon fiber-reinforced polymer", delay: 0.6 },
                { title: "Bottom Layer", desc: "Moisture resistant balance layer", delay: 0.8 },
              ].map((layer, idx) => (
                <motion.div
                  key={idx}
      ...
      <section
        id="contact"
        className="container mx-auto px-4 sm:px-6 lg:px-20 py-16 sm:py-20 lg:py-28 grid grid-cols-1 md:grid-cols-2 gap-10 sm:gap-16 items-start"
      >
        <motion.div
        ...
        >
          ...
          <p className="flex items-center space-x-2 sm:space-x-3 mb-3 sm:mb-4">
            <Phone style={{ color: "#005d28" }} className="w-5 h-5" />
            <span className="text-sm sm:text-base">+65 86442667</span>
          </p>
          <p className="flex items-center space-x-2 sm:space-x-3">
            <Mail style={{ color: "#005d28" }} className="w-5 h-5" />
            <span className="text-sm sm:text-base">zerodoor.sg@gmail.com</span>
          </p>
        </motion.div>
        ...
        <motion.form
          ...
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.8 }}
          className="bg-white p-6 sm:p-8 lg:p-10 rounded-xl shadow-lg space-y-4 sm:space-y-6"
        >
          <input
            type="text"
            name="user_name"
          ...
          <button
            type="submit"
            className="w-full py-2.5 sm:py-3 text-white font-semibold rounded-lg transition text-sm sm:text-base"
            style={{ backgroundColor: "#005d28" }}
          >
            Send Message
          </button>
